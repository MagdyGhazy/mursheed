...
class ReportServes
{
    ...
    public function profits($request,$country_id)
    {
        ...
        $allProfits = $this->allProfits($start_date, $end_date, $country_id);
        $driversProfits = $this->allProfitsWithDriver($start_date, $end_date, $country_id);
        $guidesProfits = $this->allProfitsWithGuides($start_date, $end_date, $country_id);
    ...
    public function allProfits($start_date, $end_date,$country_id)
    {
    ...
    public function allProfitsWithDriver($start_date, $end_date,$country_id)
    {
    ...
    public function allProfitsWithGuides($start_date, $end_date,$country_id)
    {
